 ...
 * @author Ryosuke
 */
public class DbTask8 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DbTask8</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DbTask8 at " + request.getContextPath() + "</h1>");
            
            //データを受信
            request.setCharacterEncoding("UTF-8");
            String name = request.getParameter("Name");
            out.print("検索ワード:"+name+"<br>");
            name = "%"+name+"%";
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    out.print("ID:"+id+", name:"+name1+", tel:"+tel+", age:"+age+", birthday:"+date+"<br>");
                }
            ...
            out.println("<a href=DbTask8.jsp>呼び出し</a>");
