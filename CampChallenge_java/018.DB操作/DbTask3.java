 ...
 * @author Ryosuke
 */
public class DbTask3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DbTask3</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DbTask3 at " + request.getContextPath() + "</h1>");
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    Date date = (java.sql.Date) rs.getDate("birthday");
