 ...
 * @author Ryosuke
 */
public class DbTask10 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DbTask10</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DbTask10 at " + request.getContextPath() + "</h1>");
            ...
            out.println("<a href=DbTask10.jsp>戻る</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
